...
#if 0
  SetMaxPacketLength(kDefaultMaxPacketSize); // HONEST no longer use
#else
  SetMaxPacketLength(net::QuicUtils::honest_DefaultMaxPacketSize); // HONEST
#endif
  HONEST_FATAL << "max_packet_length_:" << max_packet_length_ 
