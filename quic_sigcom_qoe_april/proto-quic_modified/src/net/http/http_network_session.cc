...
HttpNetworkSession::Params::Params()
    : client_socket_factory(nullptr),
      ...
      quic_clock(nullptr),
      quic_random(nullptr),
//      quic_max_packet_length(kDefaultMaxPacketSize), HONEST no longer use
      quic_max_packet_length(net::QuicUtils::honest_DefaultMaxPacketSize), // HONEST 
  ...
  HONEST_FATAL << "quic_max_packet_length:" << quic_max_packet_length ;
} 
